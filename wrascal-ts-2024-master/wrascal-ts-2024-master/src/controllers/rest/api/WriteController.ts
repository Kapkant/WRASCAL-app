...
import { BodyParams } from "@tsed/platform-params";
import { Metals_ug } from "../../../datasources/entities/Metal";
import { Conditions_ug } from "../../../datasources/entities/Condition";
import ExpressionEntryParserConfig, { EquilibriumExpression_ug, ExpressionEntry } from "../../../datasources/entities/EquilibriumExpression";
import { Ligands_ug, LigandForm, Element, MolecularFormula, MolecularFormulaEntry, Ligand } from "../../../datasources/entities/Ligand";
import { Constants_ug } from "../../../datasources/entities/Constant";
import { FootNote_ug } from "../../../datasources/entities/Footnote";
import { LiteratureMapping_ug } from "../../../datasources/entities/LiteratureMapping";

import { Constant } from "../../../datasources/entities/Constant";
import { BadRequest } from "@tsed/exceptions";
import cors from "cors";
import * as mod from "../../../models/WriteRequestModel";
import { EquilibriumExpression } from "../../../datasources/entities/EquilibriumExpression";
import { equal } from "assert";
import exp from "constants";
import { Uncertainties_ug } from "../../../datasources/entities/Uncertainties";
import { Literature_ug } from "../../../datasources/entities/Literature";
import { Note } from "../../../datasources/entities/Footnote";
import { get } from "http";

// no code changes to the class needed
